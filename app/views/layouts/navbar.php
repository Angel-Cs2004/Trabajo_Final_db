    ...
    <nav class="flex-1 py-4">
        ...
        <div class="px-4 mb-2">
            ...
            <div id="submenuConf" class="ml-4 mt-2 space-y-1 hidden">
                <a href="index.php?c=parametros&a=index" class="block px-4 py-2 text-sm hover:bg-green-700 rounded">
                    Tamaño imágenes
                </a>
            </div>
        </div>
        ...
        <div class="px-4 mb-2">
            ...
            <div id="submenuNegocios" class="ml-4 mt-2 space-y-1 hidden">
                ...
                <a href="index.php?c=negocio&a=misNegocios" class="block px-4 py-2 text-sm hover:bg-green-700 rounded">Mis negocios</a>
            </div>
        </div>
