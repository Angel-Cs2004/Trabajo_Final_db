<?php
$pageTitle = "Crear Producto (General)";
...
<main class="flex-1 px-10 pt-14 pb-14 overflow-auto">
    ...
    <div class="bg-white w-full max-w-5xl mx-auto rounded-lg shadow-lg p-8">
        ...
        <h3 class="text-xl font-semibold mb-6">Crear Producto (General)</h3>

        <form action="index.php?c=productoGeneral&a=guardar"
              method="POST"
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-xs text-gray-500 mt-1">
                    Pega la URL directa de la imagen.
                </p>
            </div>
