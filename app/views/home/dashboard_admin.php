...
<main class="flex-1 px-8 pt-14 pb-14 overflow-auto">
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <?php if (can('NEGOCIO_PROP', 'R')): ?>
                <a href="index.php?c=negocio&a=perfil"
                   class="p-6 bg-white shadow rounded-lg hover:shadow-lg transition block">
                    ...
                    <p class="text-gray-500 text-sm">Edita la información del perfil de tu negocio</p>
                </a>
            <?php endif; ?>

            <!-- Mis productos (propietario) -->
            ...
            <!-- Reportes de tu negocio (propietario) -->
